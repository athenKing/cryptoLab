...
int main(int argc, char *argv[])
{
	...
	std::vector<string> fmSketch = load_Data_into_FM(batchNum,numOTs,"../data/alice.data");

	cout<<"finished generate alice fmsketch"<<endl;
